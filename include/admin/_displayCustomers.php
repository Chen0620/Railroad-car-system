...
$query = "SELECT CustomID,Username,FirstName,LastName,Address FROM Customers";
$stmt = oci_parse($conn,$query);
oci_execute($stmt);

echo ("<h2>Display Customers</h2>");
echo ("<table id=\"myTable\" class=\"tablesorter\">");
echo("<thead><th>ID</th><th>Username</th><th>First Name</th><th>Last Name</th><th>Address</th></thead><tbody>");
